/* ==========================================================================
   BITCOIN JOURNAL - WORDPRESS ULTRA-SMOOTH FRAME SCROLL ANIMATION ENGINE
   ========================================================================== */

const TOTAL_FRAMES = (window.BTE_CONFIG && window.BTE_CONFIG.totalFrames) || 210;
const FRAMES_BASE_URL = (window.BTE_CONFIG && window.BTE_CONFIG.framesUrl) || '/wp-content/themes/bitcoin-trend-elite/assets/frames/';
const images = [];
let loadedCount = 0;
...
function getFrameUrl(index) {
  ...
  return `${FRAMES_BASE_URL}ezgif-frame-${padded}.jpg`;
}
...
function initEngine() {
  ...
  if (!canvas) return; // Exit gracefully if not on canvas hero page
